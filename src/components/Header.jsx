...
const Header = () => {
  ...
  return (
    <div className="relative z-[100]">
      <div className="fixed bg-background w-full py-3 md:py-4 shadow-none">
        ...
        <form
          ...
          className={`search mt-3 px-4 md:px-6 relative items-center w-full ${showSearchBar ? "flex" : "hidden"
            }`}
        >
          <input
            value={value}
            ...
            type="text"
            className="header-search w-full bg-[var(--surface-level-1)] px-4 py-3 text-base md:text-lg rounded-2xl border border-white/5 focus:border-primary/50 focus:shadow-glow transition-all outline-none placeholder:text-text-muted"
          />
        ...
        <div className={`${showSearchBar ? "flex flex-col mt-4 px-4 md:px-6" : "hidden"}`}>
          {isLoading ? (
            ...
            <>
              <div className="bg-[var(--surface-level-1)] rounded-xl border border-white/5 shadow-modern overflow-hidden">
                {data?.data?.map((item) => (
                  <div
                  ...
                  >
                    ...
                    <div className="info">
                      ...
                      <h6 className="text-text-muted text-sm line-clamp-1 mt-1">
