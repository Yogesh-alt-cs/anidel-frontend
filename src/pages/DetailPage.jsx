...
const DetailPage = () => {
  ...
  return (
    <main className={`${bigPoster ? "h-dvh  overflow-hidden" : ""}`}>
      {bigPoster && (
        <div className="bigposter absolute flex justify-center items-center h-full w-full z-[100] bg-surface/70">
          <div className="poster bg-lightbg rounded-md flex aspect-auto object-cover flex-col items-end relative">
            <button
              ...
              className="absolute top-2 right-2 btn-icon bg-background/50 backdrop-blur-sm text-2xl hover:text-primary-hover"
            >
              <FaWindowClose />
            </button>
            <img
