      ...
      <div className="flex flex-col gap-2">
        <div className="path flex mb-2 mx-2 items-center gap-2 text-base ">
          <Link className="" to="/home">
            <h4 className="hover:text-primary-hover">home</h4>
          </Link>
          <span className="h-1 w-1 rounded-full bg-primary"></span>
          <Link to={`/anime/${id}`}>
            <h4 className="hover:text-primary-hover">
        ...
        <div className="input w-full mt-2 flex items-end justify-end gap-3 text-end">
          <div className="btns bg-btnbg flex mx-2 rounded-child">
            <button
              className={`row item p-2 rounded-md transition-colors ${layout === "row"
                  ? "bg-primary text-white shadow-glow"
                  : "text-text-muted hover:text-primary-hover"
                }`}
            ...
            <button
              className={`column item p-2 rounded-md transition-colors ${layout === "column"
                  ? "bg-primary text-white shadow-glow"
                  : "text-text-muted hover:text-primary-hover"
                }`}
