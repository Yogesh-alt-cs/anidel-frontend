    ...
    <main className="mt-5">
      <div className="header flex justify-between items-center">
        ...
        <Link to={`/characters/${id}`}>
          <h6 className="text-sm cursor-pointer hover:text-primary-hover flex md:mr-4 items-center gap-1 text-neutral-400">
            <span>View more</span>
            <FaAngleRight />
          </h6>
        </Link>
          ...
          >
            <div className="left gap-2 flex items-center">
              ...
              <div className="flex flex-col">
                <Link to={`/${item.id.replace(":", "/")}`}>
                  <h4 className="text-xs hover:text-primary-hover">{item.name}</h4>
                </Link>
              ...
              <div className="right flex items-center gap-2">
                <div className="flex items-end flex-col">
                  <Link to={`/${item.voiceActors[0].id.replace(":", "/")}`}>
                    <h4 className="text-xs hover:text-primary-hover">
